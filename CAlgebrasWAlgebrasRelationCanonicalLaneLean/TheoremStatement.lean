...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "C*-algebra/W*-algebra embedding theorem: every separable C*-algebra admits a W*-envelope that is isometrically isomorphic and WOT-dense",
